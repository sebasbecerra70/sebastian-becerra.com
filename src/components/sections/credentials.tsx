...
const ACCENTS = ["violet", "emerald", "orange", "sky", "rose"];
...
const CredentialRow = ({
  ...
  return (
    ...
    >
      <SpotlightCard accent={accent} tilt={2} className="group">
        <Card
          className={cn(
        ...
        >
          <CardContent className="p-5 flex flex-col md:flex-row md:items-center gap-3 md:gap-6">
            <div className="flex items-center gap-3 md:w-[38%]">
              <IconTile
                accent={accent}
    ...
    <SectionWrapper id="credentials" className="py-20 md:py-28 z-10">
      <div className="w-full max-w-4xl px-4 md:px-8 mx-auto">
        <SectionHeader
          ...
          className="relative top-0 mb-10 md:mb-16 mt-0"
        />
